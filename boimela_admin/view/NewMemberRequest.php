...
$sql = "SELECT * FROM seller where SStatus= 0";
$seller = $conobj->query($sql);
$sql = "SELECT * FROM delivery where DStatus= 0";
$delivery = $conobj->query($sql);
...
<html>
    <head>
        ...
        <title>New Seller/Deliveryman Request List</title>
        <style>
            td, th {
    ...
    <body>
        ...
        <div class="center">
            <h2>New Seller/Deliveryman Request</h2>
            ...
            <table class="center">
                ...
                <tr>
                    ...
                    <td>Seller</td>
                    <td><img src="../upload/<?php echo $row['SPhoto']; ?>" alt="" width="150" height="150"></td>
                    <td>
                        <a href="../control/delete.php?method=selleraccept&id=<?php echo $row['SID']; ?>">Accept</a>
                        <br><br>
                        <a href="../control/delete.php?method=sellerreject&id=<?php echo $row['SID']; ?>">Reject</a>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <a href="../control/delete.php?method=deliverymanaccept&id=<?php echo $row['DID']; ?>">Accept</a>
                        <br><br>
                        <a href="../control/delete.php?method=deliverymanreject&id=<?php echo $row['DID']; ?>">Reject</a>
                    </td>
                </tr>
                <?php } ?>
            </table>
